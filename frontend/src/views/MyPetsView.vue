    ...
    <el-main>
      <el-card style="margin-bottom: 24px;">
        <el-form :model="petForm" label-width="100px">
          ...
          <el-row :gutter="12">
            <el-col :span="12">
              <el-input-number v-model="petForm.ageYears" :min="0" label="年" placeholder="年" style="width: 100%;" />
            </el-col>
            <el-col :span="12">
              <el-input-number v-model="petForm.ageMonths" :min="0" :max="11" label="月" placeholder="月" style="width: 100%;" />
            </el-col>
          </el-row>
        </el-form-item>
      ...
      <el-dialog :visible.sync="detailVisible" title="宠物详情" width="520px">
        <div v-if="detailPet">
...
const petForm = reactive({ id: null, petName: '', petType: 'DOG', ageYears: 0, ageMonths: 0, healthInfo: '' });
